...
import "./tasks/BlindBet";

import "dotenv/config";

// Run 'npx hardhat vars setup' to see the list of variables that need to be set
// Or set environment variables: MNEMONIC, INFURA_API_KEY, PRIVATE_KEY
...
const config: HardhatUserConfig & { fhevm?: any } = {
  ...
  fhevm: {
    networkUrl: `https://sepolia.infura.io/v3/${INFURA_API_KEY}`,
